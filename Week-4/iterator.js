...
for (const n of fibonacci) {
  // "let" could be used in place of "const" on the next line, but "const" is more correct here because each iteration gets a new binding for the
   // loop variable n and it is not modified in the loop body.
